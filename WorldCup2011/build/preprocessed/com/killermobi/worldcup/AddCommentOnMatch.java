...
public class AddCommentOnMatch implements Frame, Runnable {
   ...
   public String on1;
    ...
    public AddCommentOnMatch(String title,RssItem rssItem,DataProvider ld,RssFeedParser scoreParser) {
        this.title = title;
    ...
    public void onAdded() {
        screen = Kuix.loadScreen("addComment.xml", null);
        screen.setCurrent();
    }
    ...
    public boolean onMessage(Object identifier, Object[] arguments) {
          if ("back".equals(identifier)) {
            ...
            Kuix.getFrameHandler().pushFrame(new LiveMatchFrame(rssItem, ld, scoreParser));
        }
